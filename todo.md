...
- [x] Restore every eligible store with a public contact route to the send-ready page, including CAPTCHA and non-CAPTCHA records with personalized subject/body, while keeping the complete Stores directory separate. (Current queue includes 124 requested-niche qualified records: 108 with routes and 16 without; full directory remains separate.)
