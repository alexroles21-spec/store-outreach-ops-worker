...
- [x] Require both a verified http/https Contact page and a usable support email for Contact Queue eligibility, remove records missing either field from that queue, and preserve only the complete directory history in Stores. (Live queue now shows 0 incomplete cards; the preserved 302-record directory remains separate, and future discovery counts only complete targets toward 84.)
...
- [x] Restore Contact Queue to every non-sent qualified store with a verified Contact page, include Contact-plus-email stores in both pages, and keep Contact-only stores out of the Email Directory. (Live Pages verified 94 Contact cards; Email Directory remains separate with email-bearing records.)
